...
def analyze(df, filename):
   ...
   # df = pd.read_csv(path, header=None)
    ...
    x_val_rownums = df.iloc[:,0].str.contains("Adjusted, direct").index.tolist()
    ...
    transmission_measurements = df.iloc[x_val_rownums[1] + 1:12, 2:].values.astype(float) / transmission_baseline *100
